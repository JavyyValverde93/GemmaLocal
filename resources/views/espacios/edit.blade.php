          ...
          @csrf
            <div class="form-row">
              <div class="form-group col-md-6 mx-4">
                ...
                <input type="text" name="nombre" class="form-control" placeholder="Nombre del espacio" value="{{$espacio->nombre}}">
              </div>
            </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-auto mx-4">
                <label>Planta:</label>
                <input type="number" name="planta" step="1" required value="{{old('planta')}}" class="form-control" placeholder="Número de planta" value="{{$espacio->planta}}">
              </div>
