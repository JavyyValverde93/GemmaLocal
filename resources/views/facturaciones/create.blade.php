          ...
          @csrf
            ...
            <div class="form-row">
                <div class="form-group col-auto mx-4">
                    ...
                    <input type="number" min="01" max="12" step="1" name="caducidad" value="{{$facturacion->caducidad}}" :value="{{old('caducidad')}}" size="2"> / <input type="number"
                        step="1" min="21" max="50" name="caducidad2" value="{{$facturacion->caducidad2}}" :value="{{old('caducidad2')}}" maxlength="2">
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-auto mx-4">
                    ...
                    <input type="date" name="fecha_mandato" value="{{date("Y-m-d", $facturacion->fecha_mandato)}}" :value="{{old('fecha_mandato')}}" required>
                </div>
